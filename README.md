...
> Contemporary models of decision-making consider an individual’s preference for risk based on how they estimate the likely payoffs. However, recent work suggests that even information that cannot be used to alter future outcomes (i.e., ‘non-instrumental’ information) can have profound effects on behaviour. We tested whether the opportunity to passively observe the intermediate consequences of a decision could modulate risk preference. Across three experiments, 71 individuals chose to accept or reject gambles on a five-window slot machine. Critically, we informed participants which windows would provide veridical information about the outcome. We found that the opportunity to receive non-instrumental information about the consequences of one’s decisions significantly modulated the likelihood of gambling. This effect generalised across different stakes, and was driven by the capacity of information to resolve uncertainty. These findings provide a counterpoint to current decision-making frameworks by demonstrating the capacity of non-instrumental information to modulate the preference for risky behaviour.
