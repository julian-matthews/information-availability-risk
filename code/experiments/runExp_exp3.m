...
if ~USE_debug
    ...
    subj.initials = 'JM'; subj.ID = '899'; subj.age = '32';
...
if ~exist([data_save subj.ID '_' subj.initials '/' subj.ID subj.initials '_settings.mat'],'file')
    ...
    % Creates trials
    [TR,subj] = assign_trials_exp3(subj,cfg);
...
if USE_training
    ...
    run_training_exp3(subj,cfg,windows,wB,machine,narrowing,...
...
for tr = 1:length(TR)
    ...
    if ~isempty(find(break_trials==tr,1))
        ...
        disp('~participant has reached a break');
